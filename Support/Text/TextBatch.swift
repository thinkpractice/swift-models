...
extension Collection where Element == TextBatch {
    ...
    public func paddedAndCollated(to maxLength: Int? = nil, on device: Device = .default)
        -> TextBatch
    {
        ...
        let paddedTexts = self.map { text -> TextBatch in
            ...
            return TextBatch(
                tokenIds: Tensor(
                    copying: text.tokenIds.padded(forSizes: [
                        (before: 0, after: 0),
                        (before: 0, after: paddingSize),
                    ]), to: device),
                tokenTypeIds: Tensor(
                    copying: text.tokenTypeIds.padded(forSizes: [
                        (before: 0, after: 0),
                        (before: 0, after: paddingSize),
                    ]), to: device),
                mask: Tensor(
                    copying: text.mask.padded(forSizes: [
                        (before: 0, after: 0),
                        (before: 0, after: paddingSize),
                    ]), to: device))
        }
