        ...
        func run() throws {
            ...
            let divergenceGrid = juliaSet(
                ...
                region: parameters.region
                    ?? ComplexRegion(
                        realMinimum: -1.7, realMaximum: 1.7, imaginaryMinimum: -1.7,
                        imaginaryMaximum: 1.7),
                imageSize: parameters.imageSize ?? ImageSize(width: 1030, height: 1030),
                device: device)
    ...
    struct MandelbrotSubcommand: ParsableCommand {
        ...
        func run() throws {
            ...
            let divergenceGrid = mandelbrotSet(
                ...
                region: parameters.region
                    ?? ComplexRegion(
                        realMinimum: -2.0, realMaximum: 1.0, imaginaryMinimum: -1.3,
                        imaginaryMaximum: 1.3),
                imageSize: parameters.imageSize ?? ImageSize(width: 1030, height: 1030),
                device: device)
